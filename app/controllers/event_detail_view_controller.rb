class EventDetailViewController < UIViewController
  ...
  def requestUserCurrentLocation
    if(CLLocationManager.locationServicesEnabled)
      ...
      @location_manager.purpose= "To provide functionality based on current user's location"

      @location_manager.startUpdatingLocation

    else
      showAlertWithTitle("Location Error", "Please enable Location Services" )
  ...
  def locationManager(manager, didUpdateToLocation:newLocation, fromLocation:oldLocation)
   ...
   # @map_view_for_event.centerCoordinate = newLocation.coordinate
  end
